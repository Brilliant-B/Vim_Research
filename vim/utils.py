...
class MetricLogger(object):
    def __init__(self, delimiter="\t", args=None):
        ...
        self.train_or_test = 'test' if args.eval else 'train'
    ...
    def log_every(self, iterable, print_freq, header=None):
        ...
        for obj in iterable:
            ...
            if i % print_freq == 0 or i == len(iterable) - 1:
                ...
                with open(os.path.join(self.log_dir, f'{self.train_or_test}_log.log'), 'a+') as f:
                    if torch.cuda.is_available():
        ...
        with open(os.path.join(self.log_dir, f'{self.train_or_test}_log.log'), 'a+') as f:
            if is_main_process():
                print('{} Total time: {} ({:.4f} s / it)'.format(header, total_time_str, total_time / len(iterable)), file=f)
